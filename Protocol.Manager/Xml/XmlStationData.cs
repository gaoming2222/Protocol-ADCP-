...
namespace Protocol.Manager
{
    ...
    /// 站点数据序列化类
    /// </summary>
    public class XmlStationData
    {
        #region 单件模式
        private static XmlStationData m_sInstance;   //实例指针
        private XmlStationData()
        {
            ReadSDXml();
        }
        public static XmlStationData Instance
        {
            get { return GetInstance(); }
        }
        public static XmlStationData GetInstance()
        {
            if (m_sInstance == null)
            {
                m_sInstance = new XmlStationData();
            }
            return m_sInstance;
        }
        #endregion ///<单件模式
        ...
        public string GetProtocolBySId(string id)
        {
            if (m_mapStationgprsID == null)
            {
                ReadSDXml();
            ...
            string protocol = m_mapStationData.FindValue(id).DataProtocol;
